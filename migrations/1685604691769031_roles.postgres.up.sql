...
ALTER TABLE users
  ...
  INSERT INTO roles (id, title, abbreviation, created_at, updated_at, active) VALUES (
    1, 'Admin', 'ADM', '2024-02-05 13:03:53.244118', '2024-02-05 13:03:53.24412', true);

INSERT INTO users (id, first_name, last_name, user_active, email, password, created_at, 
